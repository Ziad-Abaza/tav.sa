                                    ...
                                    <div class="ml-3 flex-1">
                                        ...
                                        <div class="mt-2 text-sm text-primary-700 dark:text-primary-300">
                                            ...
                                            <ul class="list-disc list-inside mt-2 space-y-1">
                                                <li>Multiple API tokens with granular permissions</li>
                                                <li>Token expiration and rotation</li>
                                                <li>IP whitelisting for enhanced security</li>
                                                <li>Per-token rate limiting</li>
                                                <li>Advanced scopes and access control</li>
                                            </ul>
                                        </div>
                                        <div class="mt-4">
                                            <a href="{{ route('tenant.api-v2-management.settings.view', ['subdomain' => $subdomain]) }}"
                                                class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
                                                <x-heroicon-o-arrow-right class="w-4 h-4 mr-2" />
                                                Manage V2 API Tokens
                                            </a>
                                        </div>
                                    </div>
                                </div>
