                        ...
                        <div
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 gap-3 text-xs">
                                <div>
                                    ...
                                    <span
                                        class="ml-1 font-medium">{{ $cacheStatus['cache_driver'] ?? 'unknown' }}</span>
                                </div>
                                <div>
                                ...
                                @if (isset($cacheStatus['last_cleared']))
                                    <div>
                                        ...
                                        <span
                                            class="ml-1 font-medium">{{ $cacheStatus['last_cleared'] ?: 'Never' }}</span>
                                    </div>
                                @endif
                            </div>
                            ...
                            @if (isset($cacheStatus['error']))
                                <div
                                    ...
                                    <div class="flex items-center justify-between">
                                        <span
                                            class="text-xs text-danger-700 dark:text-danger-300">{{ $cacheStatus['error'] }}</span>
                                    ...
                                    <div class="shrink-0 mt-1">
                                        ...
                                        @elseif ($type === 'routing')
                                            <div class="p-2 bg-warning-100 dark:bg-warning-500/20 rounded-lg">
                                                <svg class="w-5 h-5 text-warning-600 dark:text-warning-400"
                                                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
                        ...
                        <div class="flex flex-wrap gap-4 sm:gap-8 w-full ">
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div class="flex items-center justify-between w-64">
                                    ...
                                    <div>
                                        <x-toggle id="production-mode-toggle" name="production_mode" :value="$production_mode"
                                            wire:change="toggleEnableProductionMode" />
                                    </div>
                                </div>
                            </div>
