...
return [
     ...
     *
     */
    'tenant_finder' => \App\Multitenancy\PathTenantFinder::class,
     ...
     */
    'switch_tenant_tasks' => [
        // Order matters: cache prefix first, then context, settings, facades, and events last
        \App\Multitenancy\Tasks\SwitchTenantContextTask::class,
        \App\Multitenancy\Tasks\SwitchTenantSettingsTask::class,
        \App\Multitenancy\Tasks\ClearTenantFacadesTask::class,
    ...
    'tenant_prefix_name' => env('TENANT_PREFIX_NAME', ''), // e.g. tenant/{tenant_name}
];
