...
return [
    'main_menu' => [
        ...
        'facebook_messenger_section' => [
            ...
            'permission' => 'tenant.facebook_messenger.view',
            'order' => 8,
            'section_id' => 'facebook_messenger',
            'feature_required' => 'facebook_messenger',
            'default_expanded' => true,
            'children' => [
                'fb_messenger_templates' => [
                    'type' => 'item',
                    'label' => 'templates',
                    'route' => 'tenant.facebook-messenger.templates',
                    'icon' => 'heroicon-o-document-text',
                    'permission' => 'tenant.facebook_messenger.view',
                    'order' => 1,
                    'active_routes' => ['tenant.facebook-messenger.templates', 'tenant.facebook-messenger.template.*'],
                ],
                'fb_messenger_campaigns' => [
                    'type' => 'item',
                    'label' => 'campaigns',
                    'route' => 'tenant.facebook-messenger.campaigns',
                    'icon' => 'heroicon-o-megaphone',
                    'permission' => 'tenant.facebook_messenger.campaigns.view',
                    'order' => 2,
                    'active_routes' => ['tenant.facebook-messenger.campaigns', 'tenant.facebook-messenger.campaign.*'],
                ],
            ],
        ],
        ...
        'marketing_section' => [
            ...
            'children' => [
                'campaigns' => [
                    ...
                    'order' => 1,
                    'active_routes' => ['tenant.campaigns.list', 'tenant.campaign.create'],
            ...
            'children' => [
                'whatsmark_settings' => [
                    ...
                    'active_routes' => [
                        ...
                        'tenant.settings.facebook-messenger',
                    ],
                ],
                'system_settings' => [
                    'type' => 'item',
