...
return [
    ...
    */
    ...
    'options' => [
        ...
        'views' => [
            'timeline' => env('DEBUGBAR_OPTIONS_VIEWS_TIMELINE', false),                  // Add the views to the timeline
            'data' => env('DEBUGBAR_OPTIONS_VIEWS_DATA', false),                         // True for all data, 'keys' for only names, false for no parameters.
            'group' => (int) env('DEBUGBAR_OPTIONS_VIEWS_GROUP', 100),                    // Group duplicate views. Pass value to auto-group, or true/false to force
        ...
        'cache' => [
            'values' => env('DEBUGBAR_OPTIONS_CACHE_VALUES', false), // Collect cache values
