...
use App\Http\Controllers\Admin\Api\Table\AdminTableSettingsController;
use App\Http\Controllers\Admin\Api\Table\coupon\CouponController;
use App\Http\Controllers\Admin\Api\Table\credit\CreditTableController;
use App\Http\Controllers\Admin\Api\Table\currency\CurrencyController;
use App\Http\Controllers\Admin\Api\Table\department\DepartmentController;
use App\Http\Controllers\Admin\Api\Table\invoice\AdmininvoiceTableController;
use App\Http\Controllers\Admin\Api\Table\Invoices\InvoicesTableController;
use App\Http\Controllers\Admin\Api\Table\languages\AdminLanguageController;
use App\Http\Controllers\Admin\Api\Table\languages\AdminLanguageLineController;
use App\Http\Controllers\Admin\Api\Table\languages\AdminTenantLanguageController;
use App\Http\Controllers\Admin\Api\Table\pages\PageTableController;
use App\Http\Controllers\Admin\Api\Table\roles\AdminRoleAssigneeTableController;
use App\Http\Controllers\Admin\Api\Table\roles\AdminRoleTableController;
use App\Http\Controllers\Admin\Api\Table\Subscriptions\SubscriptionTableController;
use App\Http\Controllers\Admin\Api\Table\tax\TaxTableController;
use App\Http\Controllers\Admin\Api\Table\Tenants\TenantTableController;
use App\Http\Controllers\Admin\Api\Table\transaction\TransactionTableController;
use App\Http\Controllers\Admin\Api\Table\user\UserTableController;
...
Route::middleware(['auth', SanitizeInputs::class, AdminMiddleware::class, EnsureEmailIsVerified::class])
    ...
    ->group(function () {
        ...
        Route::prefix('api')->name('api.')->group(function () {
            Route::get('/table/{resource}/settings', AdminTableSettingsController::class)->name('table.settings');
            Route::get('/tenants', [TenantTableController::class, 'index'])->name('tenants.index');
            Route::get('/subscriptions', [SubscriptionTableController::class, 'index'])->name('subscriptions.index');
            Route::get('/tax', [TaxTableController::class, 'index'])->name('tax.index');
            Route::get('/page', [PageTableController::class, 'index'])->name(name: 'page.index');
            Route::patch('/page/{id}/toggle-status', [PageTableController::class, 'toggleStatus']);
            Route::get('/credit', [CreditTableController::class, 'index'])->name('credit.index');
            Route::get('/invoices', [InvoicesTableController::class, 'index'])->name('invoices.index');
            Route::get('/transaction', [TransactionTableController::class, 'index'])->name('transaction.index');
            Route::get('/maininvoice', [AdmininvoiceTableController::class, 'index'])->name('maininvoice.index');
            Route::get('/department', [DepartmentController::class, 'index'])->name('department-index');
            Route::patch('/department/{id}/toggle-status', [DepartmentController::class, 'toggleStatus']);
            Route::get('/department-filters', [DepartmentController::class, 'filters'])->name('department.filters');
            Route::get('/admin-languages', [AdminLanguageController::class, 'index'])->name('admin-languages.index');
            Route::get('/admin-tenant-languages', [AdminTenantLanguageController::class, 'index'])->name('admin-tenant-languages.index');
            Route::get('/admin-roles', [AdminRoleTableController::class, 'index'])->name('admin-roles.index');
            Route::get('/admin-role-assignees', [AdminRoleAssigneeTableController::class, 'index'])->name('admin-role-assignees.index');
            Route::get('/users', [UserTableController::class, 'index']);
            Route::patch('/users/{id}/toggle-active', [UserTableController::class, 'toggleActive']);
            Route::get('/admin-language-lines', [AdminLanguageLineController::class, 'index'])->name('admin-language-lines.index');
            Route::patch('/admin-language-lines/{key}/field', [AdminLanguageLineController::class, 'updateField'])->name('admin-language-lines.update-field');
            Route::get('/admin-language-lines/export', [AdminLanguageLineController::class, 'export'])->name('admin-language-lines.export');
            Route::get('/currency', [CurrencyController::class, 'index'])->name('currency-index');
            Route::patch('/currency/{id}/toggle-status', [CurrencyController::class, 'toggleStatus']);
            Route::get('/coupon', [CouponController::class, 'index'])->name('coupon-index');
            Route::get('/coupon-filters', [CouponController::class, 'filters'])->name('coupon.filters');
            Route::patch('/tenants/{tenant}/status', [TenantTableController::class, 'updateStatus'])
                ->name('tenants.update-status');
            Route::get('/tenants/status-options', [TenantTableController::class, 'statusOptions']);
        });
    });
