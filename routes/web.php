...
use App\Http\Controllers\FacebookMessenger\FacebookMessengerWebhookController;
...
// API Documentation (requires any authenticated user - admin, tenant, or staff)
Route::get('/api-docs', function () {
    return view('swagger-docs.api-docs');
...
// Facebook Messenger Webhook Route (Supports GET & POST)
Route::match(['get', 'post'], '/facebook/messenger/webhook', [FacebookMessengerWebhookController::class, '__invoke'])
