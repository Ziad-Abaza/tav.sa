...
async function searchLocation() {
    ...
    try {
        ...
        const errorMessage = error.message || "An error occurred while searching for locations.";
...
async function reverseGeocode(lat, lng) {
    try {
        ...
        const errorMessage = error.message || "An error occurred while reverse geocoding the location.";    
        showNotification(errorMessage, "danger");
