...
function exportCsv() {
    ...
    const url = `/${props.subdomain}/api/tenant-language-lines/export${qs ? '?' + qs : ''}`
...
<template>
    <div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div class="p-4">
            <ResourceDataTable ref="table" resource="tenant-language-lines" :subdomain="subdomain"  :extra-params="{ languageCode }"
            :editable-fields="{
        value: { type: 'text' }
    }"
                storage-key="tenant_language_lines_table">
