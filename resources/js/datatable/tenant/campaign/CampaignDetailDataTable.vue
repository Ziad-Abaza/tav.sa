...
function exportCsv() {
    ...
    window.open(`/${props.subdomain}/api/campaign-details/export?${qs}`)
}
</script>
...
<template>
    <div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div class="p-4">
            <ResourceDataTable ref="table" resource="campaign-details" :subdomain="subdomain"
                :extra-params="{ campaign_id: campaignId }" storage-key="campaign_details_table">
