                ...
                >
                    ...
                    <div class="p-6">
                        <form @submit.prevent="handleSubmit">
                                ...
                                <div class="grid grid-cols-1 gap-6">
                                    ...
                                    <div class="grid grid-cols-1 gap-4">
                                        <div>
                                            ...
                                            >
                                                <CaInformation
                                                    class="w-3 h-3 text-primary-600 flex-shrink-0"
                                                />
                                                <span>
                                                    Use only
                                                    <strong
                                                    ...
                                                    and
                                                    <strong
                                                        >underscores (_)</strong
                                                    >. Spaces and special
                                                    characters are not allowed.
                                                    Example:
                                                    <code
                                                        class="ml-1 text-primary-600"
                                                        >order_status_update</code
                                                    >
                                                </span>
                                            </p>
                                        </div>
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    "
                                                    :class="[
                                                        'block mt-1 w-full rounded-md shadow-sm text-slate-900 dark:text-slate-200 sm:text-sm focus:ring-info-500 focus:border-info-500 dark:bg-slate-800 dark:placeholder-slate-500 dark:focus:placeholder-slate-600',
                                                        buttonErrors[index]?.text ? 'border-red-500 dark:border-red-500' : 'border-slate-300 dark:border-slate-500'
                                                    ]"
                                                />
                                                <p
                                                    v-if="buttonErrors[index]?.text"
                                                    class="text-xs text-red-500 dark:text-red-400 mt-1"
                                                >
                                                    {{ buttonErrors[index].text }}
                                                </p>
                                                <p
                                                    v-else
                                            ...
                                            <div v-if="button.type === 'URL'">
                                                ...
                                                <input
                                                    ...
                                                    :class="[
                                                        'block mt-1 w-full rounded-md shadow-sm text-slate-900 dark:text-slate-200 sm:text-sm focus:ring-info-500 focus:border-info-500 dark:bg-slate-800 dark:placeholder-slate-500 dark:focus:placeholder-slate-600',
                                                        buttonErrors[index]?.url ? 'border-red-500 dark:border-red-500' : 'border-slate-300 dark:border-slate-500'
                                                    ]"
                                                />
                                                <p
                                                    v-if="buttonErrors[index]?.url"
                                                    class="text-xs text-red-500 dark:text-red-400 mt-1"
                                                >
                                                    {{ buttonErrors[index].url }}
                                                </p>
                                                <p
                                                    v-else
                                                    class="text-xs text-gray-500 dark:text-slate-400 mt-1"
                                            ...
                                            >
                                                ...
                                                <input
                                                    ...
                                                    :class="[
                                                        'block mt-1 w-full rounded-md shadow-sm text-slate-900 dark:text-slate-200 sm:text-sm focus:ring-info-500 focus:border-info-500 dark:bg-slate-800 dark:placeholder-slate-500 dark:focus:placeholder-slate-600',
                                                        buttonErrors[index]?.phone_number ? 'border-red-500 dark:border-red-500' : 'border-slate-300 dark:border-slate-500'
                                                    ]"
                                                />
                                                <p
                                                    v-if="buttonErrors[index]?.phone_number"
                                                    class="text-xs text-red-500 dark:text-red-400 mt-1"
                                                >
                                                    {{ buttonErrors[index].phone_number }}
                                                </p>
                                                <p
                                                    v-else
                                                    class="text-xs text-gray-500 dark:text-slate-400 mt-1"
                            ...
                            <!-- Authentication Tab -->
                            <div
                                v-show="activeTab === 'authentication'"
                                class="space-y-6"
                            >
                                <AuthenticationTemplateForm
                                    :model-value="form.authentication"
                                    @update:addSecurityRecommendation="
                                        form.authentication.addSecurityRecommendation =
                                            $event
                                    "
                                    @update:expirationMinutes="
                                        form.authentication.expirationMinutes =
                                            $event
                                    "
                                    @update:ttlSeconds="
                                        form.authentication.ttlSeconds = $event
                                    "
                                    @update:buttonType="
                                        form.authentication.buttonType = $event
                                    "
                                    @update:buttonText="
                                        form.authentication.buttonText = $event
                                    "
                                    @update:autofillText="
                                        form.authentication.autofillText =
                                            $event
                                    "
                                    @update:packageName="
                                        form.authentication.packageName = $event
                                    "
                                    @update:signatureHash="
                                        form.authentication.signatureHash =
                                            $event
                                    "
                                    ref="authFormRef"
                                />
...
import AuthenticationTemplateForm from "./AuthenticationTemplateForm.vue";
...
const tabs = computed(() => {
    // For authentication templates, show different tab structure
    if (isAuthenticationTemplate.value) {
        return [
            { id: "basic", name: t("basic_info"), shortName: t("basic") },
            {
                id: "authentication",
                name: t("authentication_config"),
                shortName: t("auth"),
            },
        ];
    }

    // Standard tabs for other template types
    return [
        { id: "basic", name: t("basic_info"), shortName: t("basic") },
...
const getTabValidation = (tabId) => {
    switch (tabId) {
        ...
        case "authentication":
            ...
            const isAuthValid =
                form.authentication.buttonType === "ONE_TAP" ||
                form.authentication.buttonType === "ZERO_TAP"
                    ? form.authentication.packageName &&
                      form.authentication.signatureHash
                    : true;
            return {
                isValid: isAuthValid,
                errors: [
                    (form.authentication.buttonType === "ONE_TAP" ||
                        form.authentication.buttonType === "ZERO_TAP") &&
                        !form.authentication.packageName &&
                        "Package name is required for ONE_TAP and ZERO_TAP",
                    (form.authentication.buttonType === "ONE_TAP" ||
                        form.authentication.buttonType === "ZERO_TAP") &&
                        !form.authentication.signatureHash &&
                        "Signature hash is required for ONE_TAP and ZERO_TAP",
                ].filter(Boolean),
            };
        case "footer":
        case "buttons":
...
const isAuthenticationTemplate = computed(() => {
    return form.category === "AUTHENTICATION";
});
// Form state
const form = reactive({
    template_name: "",
...
const isFormValid = computed(() => {
    ...
    if (isAuthenticationTemplate.value) {
        ...
        // For ONE_TAP and ZERO_TAP, validate package name and signature hash
        if (
            form.authentication.buttonType === "ONE_TAP" ||
            form.authentication.buttonType === "ZERO_TAP"
        ) {
            return (
                basicValid &&
                form.authentication.packageName.trim() &&
                form.authentication.signatureHash.trim()
            );
        }
    ...
    if (
        ...
        if (!basicValid || !headerVariableValid) {
            return false;
        }
    } else if (!basicValid) {
        return false;
    ...
    // Button validation
    if (form.data.buttons.length > 0) {
        for (let i = 0; i < form.data.buttons.length; i++) {
            const button = form.data.buttons[i];
            ...
            if (button.type === "PHONE_NUMBER") {
                ...
                if (!isValidPhoneNumber(button.phone_number)) {
                    return false;
                }
            }
        }
...
const handleSubmit = async () => {
    ...
    // Validate buttons if any exist
    if (form.data.buttons.length > 0) {
        let hasError = false;
        buttonErrors.value = form.data.buttons.map(() => ({
            text: '',
            url: '',
            phone_number: ''
        }));
        ...
        for (let i = 0; i < form.data.buttons.length; i++) {
            ...
            // Validate button text is required
            if (!button.text || !button.text.trim()) {
                buttonErrors.value[i].text = t("this_field_is_required");
                hasError = true;
            }
            ...
            if (button.type === "URL") {
                if (!button.url || !button.url.trim()) {
                    buttonErrors.value[i].url = t("this_field_is_required");
                    hasError = true;
                } else if (!isValidUrl(button.url.trim())) {
                    buttonErrors.value[i].url = t("please_enter_valid_url");
                    hasError = true;
                }
            }
            ...
            if (button.type === "PHONE_NUMBER") {
                if (!button.phone_number || !button.phone_number.trim()) {
                    buttonErrors.value[i].phone_number = t("this_field_is_required");
                    hasError = true;
                } else if (!isValidPhoneNumber(button.phone_number)) {
                    buttonErrors.value[i].phone_number = t("please_enter_valid_phone_number");
                    hasError = true;
                }
            }
        }
    ...
    // Handle authentication template differently
    if (isAuthenticationTemplate.value) {
        // Validate authentication form
        if (authFormRef.value && !authFormRef.value.validate()) {
            return;
        }
        ...
        const authTemplateData = {
            ...
            message_send_ttl_seconds: form.authentication.ttlSeconds,
            add_security_recommendation:
                form.authentication.addSecurityRecommendation,
            code_expiration_minutes: form.authentication.expirationMinutes,
            data: {
                body: {
                    add_security_recommendation:
                        form.authentication.addSecurityRecommendation,
                ...
                buttons: [
                    {
                        type: "OTP",
                        otp_type: form.authentication.buttonType,
                        text:
                            form.authentication.buttonType === "COPY_CODE"
                                ? form.authentication.buttonText
                                : form.authentication.buttonType === "ONE_TAP"
                                  ? form.authentication.autofillText
                                  : undefined,
                        ...(form.authentication.buttonType === "ONE_TAP" ||
                        form.authentication.buttonType === "ZERO_TAP"
                            ? {
                                  package_name: form.authentication.packageName,
                                  signature_hash:
                                      form.authentication.signatureHash,
                              }
                            : {}),
                ...
                ...(form.authentication.expirationMinutes > 0
                    ? {
                          footer: {
...
watch(
    () => form.data.buttons,
    () => {
        // Clear button errors when buttons array changes
        buttonErrors.value = [];
    },
    { deep: true }
);
