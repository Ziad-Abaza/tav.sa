    ...
    >
        ...
        >
            <div class="p-2 rounded-full bg-primary-100 dark:bg-primary-900">
                <AkFile class="h-6 w-6 text-primary-600" />
            </div>
            ...
            <div>
                ...
                <p class="text-sm text-slate-500 dark:text-slate-400">
                    customize your message with variables and media
                </p>
            </div>
        </div>
                ...
                <div class="space-y-4">
                    ...
                    >
                        ...
                        >
                            ...
                            This value will be used as the OTP code in the
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            >
                                ...
                                >
                                    <li>
                                        The first body variable is the OTP code
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        Use merge fields for dynamic OTP
                                        generation (e.g., @otp_code)
                                    </li>
                                </ul>
                            </div>
                        </div>
