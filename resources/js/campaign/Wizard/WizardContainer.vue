<template>
    <div class="flex w-full">
        ...
        <div
            class="flex-1 bg-white dark:bg-slate-900 rounded-md border border-slate-300 dark:border-slate-700"
        >
            <!-- Tabs -->
            <div class="p-4 border-b border-slate-300 dark:border-slate-600">
                <WizardTabs
                    :tabs="tabs"
