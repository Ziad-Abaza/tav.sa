<div class="relative">
    ...
    <x-breadcrumb :items="[['label' => t('dashboard'), 'route' => route('admin.dashboard')], ['label' => t('tenant_languages')]]" />
    ...
    <div class="mt-8 lg:mt-0">
         <div wire:ignore>
            <div id="admin-tenant-languages-datatable"></div>
        </div>
    </div>
            ...
            <div class="px-6 space-y-3">
                <div>
                    <div class="flex item-center justify-start gap-1">
                        ...
                        <label
                            class="dark:text-secondary-300 block text-sm font-medium text-secondary-700">{{ t('language_name') }}</label>
                    </div>
                ...
                <div>
                    <div class="flex item-center justify-start gap-1">
                        <span class="text-danger-500">*</span>
                        <label
                            class="dark:text-secondary-300 block text-sm font-medium text-secondary-700">{{ t('language_code') }}</label>
                    </div>
            ...
            <div class="px-6 space-y-6">
                ...
                <div class="space-y-3">
                    <div>
                        ...
                        <x-input wire:model.defer="name" type="text" id="edit_name" class="w-full"
                            placeholder="e.g., French" />
                        <x-input-error for="name" class="mt-2" />
                    </div>
                    ...
                    <div>
                        ...
                        <x-input wire:model.defer="code" type="text" id="edit_code" class="w-full"
                            placeholder="e.g., fr" />
                        <x-input-error for="code" class="mt-2" />
                    </div>
                </div>
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        <p class="text-xs text-secondary-500 dark:text-secondary-400">
                                            {{ t('upload_maximum_file_size') }} <code
                                                class="bg-secondary-100 dark:bg-secondary-700 px-1 rounded">tenant_{{ $code ?? 'code' }}.json</code>
                                        </p>
                                        </p>
                                    </div>
                                </div>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div
                                            ...
                                            <p class="text-xs text-blue-700 dark:text-blue-300">
                                                ...
                                                Ready to upload to public/lang/ directory. Existing files will be backed
                                                up.
                                            </p>
                                        </div>
                                    </div>
