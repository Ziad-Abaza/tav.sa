<div>
    <!-- Breadcrumb -->
    <x-breadcrumb :items="[['label' => 'Dashboard', 'route' => route('admin.dashboard')], ['label' => t('coupons')]]" />
    ...
    <div class="mb-3">
        <div class="flex flex-col md:flex-row justify-between items-center">
            ...
            @if (checkPermission('admin.coupon.create'))
    ...
    <div>
        <div wire:ignore>
            <div id="coupon-datatable" data-subdomain="{{ tenant_subdomain() }}"></div>
        </div>
    </div>

    <!-- Confirm Delete Modal -->
    <x-modal.confirm-box :id="'confirm-delete-modal'" title="Delete Coupon"
