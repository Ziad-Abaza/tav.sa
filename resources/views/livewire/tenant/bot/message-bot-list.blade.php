<div class="relative">
    ...
    <div class="mt-8 lg:mt-0">
        <div wire:ignore>
            <div id="messagebot-datatable" data-subdomain="{{ tenant_subdomain() }}"></div>
        </div>
    </div>
    ...
    <x-modal.confirm-box :maxWidth="'lg'" :id="'delete-messagebot-modal'" title="{{ t('delete_message_bot') }}"
        ...
        <div class="border-neutral-200  flex justify-end items-center sm:block space-x-3 bg-gray-100 dark:bg-gray-700 ">
