            ...
            <x-dropdown>
                ...
                {{ in_array(request()->route()->getName(), [
                    ...
                    <a href="{{ url('/api-docs') }}" target="_blank"
                        class="group flex items-center px-5 py-2 text-sm font-medium rounded-r-none text-gray-600 hover:bg-primary-100 hover:text-primary-800 dark:text-slate-300 dark:hover:bg-slate-700 dark:hover:text-white">
                        <svg class="mr-2 flex-shrink-0 h-6 w-6 text-gray-500 group-hover:text-primary-700 dark:text-slate-400 group-hover:dark:text-slate-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
