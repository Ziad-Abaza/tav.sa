<div>
    ...
    <x-breadcrumb :items="[
        ...
        ['label' => t('role'), 'route' => tenant_route('tenant.roles.list')],
        ...
        <div class="flex flex-col lg:flex-row gap-6 mb-20">
                ...
                <x-card class="rounded-lg shadow-sm">
                    <x-slot:content>
                        ...
                        <div class="border rounded-lg border-gray-200 dark:border-gray-700 overflow-hidden ">
                            ...
                            <!-- Table Body -->
                            <div class="max-h-[500px] overflow-y-auto" x-data="{
                                chatView: @json(in_array('tenant.chat.view', $selectedPermissionNames ?? [])),
                                chatReadOnly: @json(in_array('tenant.chat.read_only', $selectedPermissionNames ?? [])),
                                contactView: @json(in_array('tenant.contact.view', $selectedPermissionNames ?? [])),
                                contactViewOwn: @json(in_array('tenant.contact.view_own', $selectedPermissionNames ?? [])),
                            
                            }" x-init="if (chatView) chatReadOnly = false;
                                    ...
                                    <div
                                        ...
                                        <div class="grid grid-cols-12 gap-0">
                                            ...
                                            <div
                                                ...
                                                {{ $group === 'whatsmark_settings' ? t('application_settings') : ucfirst(str_replace('_', ' ', $group)) }}
                                            </div>
                                                        ...
                                                        <label
                                                            ...
                                                            x-bind:class="{
                                                                ' dark:bg-gray-800 opacity-50 cursor-not-allowed': (
                                                                    '{{ $permission['name'] }}'
                                                                    === 'tenant.chat.view' && chatReadOnly
                                                                ) || (
                                                                    '{{ $permission['name'] }}'
                                                                    === 'tenant.chat.read_only' && chatView
                                                                ) || (
                                                                    '{{ $permission['name'] }}'
                                                                    === 'tenant.contact.view' && contactViewOwn
                                                                ) || (
                                                                    '{{ $permission['name'] }}'
                                                                    === 'tenant.contact.view_own' && contactView
                                                                )
                                                            }">
            ...
            <div class="w-full lg:w-4/12">
                <x-card class="rounded-lg shadow-sm">
                    ...
                    <x-slot:content>
                        <div id="role-assignee-datatable" data-subdomain="{{ tenant_subdomain() }}"
