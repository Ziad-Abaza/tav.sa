                ...
                <div class="mt-3">
                    <div class="flex items-baseline gap-2">
                        <span class="text-3xl font-bold text-gray-800 dark:text-gray-200">
                            {{ ($sentCount ?? 0) + ($deliverCount ?? 0) + ($failedCount ?? 0) }}
                        </span>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 dark:border-slate-700 dark:bg-slate-800"
            ...
            <div class="p-6">
                <div x-show="activeTab === 'queue'" class="text-gray-500">
                      <div id="campaign-details-datatable" data-subdomain="{{ tenant_subdomain() }}"
                            data-campaign-id="{{ $campaign->id }}">
                    </div> 
                </div>
                <div x-show="activeTab === 'executed'" class="text-gray-500">
                      <div id="campaign-executed-datatable" data-subdomain="{{ tenant_subdomain() }}"
                            data-campaign-id="{{ $campaign->id }}">
                      </div> 
                </div>
            </div>
