<div class="relative">
    ...
    <x-breadcrumb :items="[['label' => t('dashboard'), 'route' => tenant_route('tenant.dashboard')], ['label' => t('ai_prompt')]]" />
    ...
    <div class="mt-8 lg:mt-0">
        <div wire:ignore>
            <div id="aiprompt-datatable" data-subdomain="{{ tenant_subdomain() }}"></div>
        </div>
    </div>
