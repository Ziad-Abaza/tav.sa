            ...
            <section x-data="{
                ...
                <div class="max-w-6xl mx-auto">
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                        <!-- Left Content -->
                        <div class="col-span-1 flex flex-col justify-center" data-aos="fade-right"
                            ...
                            <template x-if="totalPairs > 1">
                                <div class="flex space-x-2" data-aos="fade-up" data-aos-duration="600"
                                    data-aos-delay="800">
                                    <template x-for="(pair, index) in Array.from({length: totalPairs})"
                                        :key="index">
                        ...
                        <div class="col-span-2 relative" data-aos="fade-left" data-aos-duration="1200"
                            data-aos-delay="400">
                            <!-- Fixed height container to prevent layout shift -->
                            <div class="min-h-[240px] relative">
                                <template x-for="(pair, pairIndex) in Array.from({length: totalPairs})"
                                    :key="pairIndex">
