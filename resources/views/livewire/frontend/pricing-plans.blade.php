            ...
            <div @if($showBillingToggle)
                ...
                <div class="flex items-baseline justify-center my-4">
                    <div class="flex flex-col items-center">
                        ...
                        @if (!empty($pricingSettings['theme.plans_page_title']))
                        <div class="flex flex-col items-center mt-3">
                            <span class="text-lg font-semibold text-primary-500 mb-1">+</span>
                            <a href="{{ $pricingSettings['theme.plans_page_link'] ?: '#' }}" target="_blank"
                                class="flex items-center gap-1 font-medium text-info-600 hover:text-info-700 dark:text-info-400 dark:hover:text-info-300 transition">
                                {{ $pricingSettings['theme.plans_page_title'] }}
                ...
                <ul role="list" class="mb-8 space-y-4 text-left">
                    ...
                    <li class="flex items-center space-x-3">
                        <svg class="w-5 h-5 text-primary-500 dark:text-primary-400 flex-shrink-0" fill="currentColor"
