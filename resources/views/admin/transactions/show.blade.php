                                                    ...
                                                    <dl class="grid grid-cols-1 gap-x-4 gap-y-2 sm:grid-cols-2">
                                                        @foreach ($additionalDetails as $key => $value)
                                                            <div>
                                                                ...
                                                                <dd class="text-xs text-gray-900 dark:text-gray-200  break-all">{{ $value }}</dd>
                                                            </div>
                                                        @endforeach
                                                    </dl>
                                                @else
                            ...
                            <div x-data="{
                                ...
                                <div x-show="showModal" class="fixed inset-0 z-50 overflow-y-auto"
                                    ...
                                    <div
                                        ...
                                        <div class="fixed inset-0 transition-opacity bg-black/60 bg-opacity-75 dark:bg-gray-900 dark:bg-opacity-75"
