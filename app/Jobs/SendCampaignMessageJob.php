...
class SendCampaignMessageJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        try {
            ...
            $isCarouselTemplate = ! empty($template['template_type']) && strtoupper($template['template_type']) == 'CAROUSEL';
            ...
            $rel_data = array_merge(
                ...
                [
                    ...
                    'whatsapp_media_ids' => $campaign->whatsapp_media_ids ?? null,
            ...
            // For carousel templates, add carousel-specific data
            if ($isCarouselTemplate) {
                // Priority: Campaign cards_params > Template cards_json
                $rel_data['cards_params'] = $campaign->cards_params ?? $template['cards_json'] ?? [];

                // Ensure template_type is passed for carousel detection
                $rel_data['template_type'] = $template['template_type'];
            }
