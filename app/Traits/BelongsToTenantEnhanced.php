...
/**
 * @deprecated Use BelongsToTenant instead. The improvements from this trait
 *             (qualified table names, scopeWithoutTenantScope, belongsToCurrentTenant)
 *             have been merged into BelongsToTenant.
