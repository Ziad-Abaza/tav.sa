...
class ChatMessage extends BaseModel
{
    ...
    /**
     * Scope messages from Facebook Messenger
     */
    public function scopeFromFacebookMessenger($query)
    {
        return $query->where('source', self::SOURCE_FACEBOOK_MESSENGER);
    }

    /**
     * Scope messages from WhatsApp
     */
    ...
    /**
     * Check if message is from Facebook Messenger
     */
    public function isFacebookMessenger(): bool
    {
        return $this->source === self::SOURCE_FACEBOOK_MESSENGER;
    }
