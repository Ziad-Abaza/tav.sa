...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        // Register module asset manager
        $this->app->singleton(\App\Services\ModuleAssetManager::class);
    ...
    public function boot(): void
    {
        ...
        // Register module asset manifest hooks
        $this->registerModuleAssetHooks();
     ...
     * Register module asset manifest hooks
     */
    private function registerModuleAssetHooks(): void
    {
        $listener = app(\App\Listeners\ModuleAssetManifestListener::class);
        $listener->subscribe();
    }
