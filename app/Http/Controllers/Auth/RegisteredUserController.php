...
class RegisteredUserController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        if (! $request->filled('plan_id')) {
            ...
            // Use cached plans for better performance
            $plans = PlanFeatureCache::getAllPlansWithFeatures()
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $validation_data = [
            [
                ...
                'phone' => ['required', 'unique:'.User::class, 'regex:/^\+?[0-9]+$/', new PurifiedInput(t('sql_injection_error'))],
