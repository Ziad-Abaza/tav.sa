...
class PermissionSeeder extends Seeder
{
    public function run()
    {
        ...
        $tenantPermissions = [
            ...
            'tenant.facebook_messenger.view',
            'tenant.facebook_messenger.create',
            'tenant.facebook_messenger.edit',
            'tenant.facebook_messenger.delete',
            'tenant.facebook_messenger.send_test',
            ...
            'tenant.facebook_messenger.settings.view',
            'tenant.facebook_messenger.settings.edit',
