...
class SettingsManager
{
    ...
    /**
     * Static cache for settings classes.
     */
    protected static ?array $cachedClasses = null;

    /**
     * Get all settings classes with static in-memory caching.
     */
    public function getSettingsClasses(): array
    {
        ...
        self::$cachedClasses = Cache::remember($cacheKey, $this->cacheTtl, function () {
     ...
     * Note: Settings are already cached at the group level, no need for additional caching.
     *
     * @throws SettingsException
     */
