...
class UpdateChecker
{
    ...
    public function downloadUpdate(
        ...
        try {
            $mainFile = $this->downloadFile('main', $updateId, $version, $token, $license, $client, $mode);
            ...
            if ($needsSqlUpdate) {
                $sqlFile = $this->downloadFile('sql', $updateId, $version, $token, $license, $client, $mode);
    ...
    private function downloadFile(string $type, string $updateId, string $version, string $token, ?string $license, ?string $client, ?string $mode = 'install')
    {
